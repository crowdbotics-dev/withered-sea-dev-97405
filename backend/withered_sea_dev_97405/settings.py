"""
Django settings for withered_sea_dev_97405 project.
...
ROOT_URLCONF = 'withered_sea_dev_97405.urls'
...
WSGI_APPLICATION = 'withered_sea_dev_97405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_sea_dev_97405 API",
    "DESCRIPTION": "API documentation for withered_sea_dev_97405 App",
    "VERSION": "v1",
}
